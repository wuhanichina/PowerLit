...
[使用场景](#使用场景) · [同类项目参考](#同类项目参考) · [项目特色](#项目特色) · [五分钟上手](#五分钟上手) · [PowerLit 管理哪些材料](#powerlit-管理哪些材料) · [常见任务怎么做](#常见任务怎么做) · [推荐工作流](#推荐工作流) · [目录结构](#目录结构) · [配置说明](#配置说明) · [Web 与 API](#web-与-api) · [提交边界](#提交边界) · [版本说明](#版本说明)
